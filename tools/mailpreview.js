...
/* =============================================================================
   ...
   un cliente inventado y con la clave de Resend puesta—. Aquí se ven los dos
...
function show(title, message) {
    ...
    if (message.reply_to) console.log(`Responder:${message.reply_to.join(', ')}`);
...
console.log(`\n(Con AUTOCOLOR_RESEND_KEY puesta, notifyNewRequest() mandaría estos.)`);
